function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      <path
        fill="#34A853"
        d="M12 24c3.24 0 5.96-1.07 7.95-2.92l-3.88-3c-1.08.72-2.46 1.15-4.07 1.15-3.13 0-5.78-2.11-6.73-4.95H1.26v3.1A11.998 11.998 0 0 0 12 24Z"
      />
      <path
        fill="#FBBC05"
...
export default function SocialAuthButtons() {
  return (
    <div className="w-full">
      <button
        type="button"
        className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-[#D5DACD] bg-white px-4 py-2.5 text-sm font-medium text-[#0A192F] shadow-sm transition-colors duration-200 hover:border-[#8C5A3C]/40 hover:bg-[#F5EBE0]/60"
      >
